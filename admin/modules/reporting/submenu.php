...
$menu[] = array(__('10 Peminjam Terbanyak'), MWB.'reporting/customs/most_active_loaner.php', __('Most Active Loaner'));
$menu[] = array(__('10 Pengunjugn Teraktif'), MWB.'reporting/customs/most_active_visitor.php', __('Most Active Visitor'));
$menu[] = array(__('Laporan Denda per Bulan'), MWB.'reporting/customs/fines_chart_by_mounth.php', __('Fines Report by Mounth'));
$menu[] = array(__('Laporan Denda per Tahun'), MWB.'reporting/customs/fines_chart_by_year.php', __('Fines Report by Year'));
